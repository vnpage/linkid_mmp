...
rm -rf build/linkid_mmp_internal.xcframework && \
# rm -rf build/CryptoSwift.xcframework && \
# rm -rf build/GRDB.xcframework && \

xcodebuild -create-xcframework \
  -framework archives/ios_devices.xcarchive/Products/Library/Frameworks/linkid_mmp_internal.framework \
  -framework archives/ios_simulators.xcarchive/Products/Library/Frameworks/linkid_mmp_internal.framework \
  -output build/linkid_mmp_internal.xcframework
# xcodebuild -create-xcframework \
