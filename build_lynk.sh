...
rm -rf build/lynkid_afl.xcframework && \
# rm -rf build/CryptoSwift.xcframework && \
# rm -rf build/GRDB.xcframework && \

xcodebuild -create-xcframework \
  -framework archives/ios_devices.xcarchive/Products/Library/Frameworks/lynkid_afl.framework \
  -framework archives/ios_simulators.xcarchive/Products/Library/Frameworks/lynkid_afl.framework \
  -output build/lynkid_afl.xcframework
# xcodebuild -create-xcframework \
