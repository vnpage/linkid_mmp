...
Pod::Spec.new do |s|
  s.name             = 'linkid_mmp'
  s.version          = '0.1.0'
  s.summary          = 'A short description of linkid_mmp.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Tuan Dinh/linkid_mmp'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tuan Dinh' => 'leonacky@gmail.com' }
  s.source           = { :git => 'https://github.com/Tuan Dinh/linkid_mmp.git', :tag => s.version.to_s }
