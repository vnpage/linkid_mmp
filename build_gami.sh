...
rm -rf build/gami_afl.xcframework && \
# rm -rf build/CryptoSwift.xcframework && \
# rm -rf build/GRDB.xcframework && \

xcodebuild -create-xcframework \
  -framework archives/ios_devices.xcarchive/Products/Library/Frameworks/gami_afl.framework \
  -framework archives/ios_simulators.xcarchive/Products/Library/Frameworks/gami_afl.framework \
  -output build/gami_afl.xcframework
# xcodebuild -create-xcframework \
